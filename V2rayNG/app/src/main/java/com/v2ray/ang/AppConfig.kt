...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/sahandmarami/Zero-VPN"
    const val APP_API_URL = "https://api.github.com/repos/sahandmarami/Zero-VPN/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/sahandmarami/Zero-VPN/master/PRIVACY.md"
    const val APP_PROMOTION_URL = "aHR0cHM6Ly9naXRodWIuY29tL3NhaGFuZG1hcmFtaS9aZXJvLVZQTg=="
    const val TG_CHANNEL_URL = "https://t.me/zerovpn_app"
