...
android {
    ...
    signingConfigs {
        create("release") {
            storeFile = rootProject.file("../signing/zero-vpn.jks")
            storePassword = "zerovpn123"
            keyAlias = "zerovpn"
            keyPassword = "zerovpn123"
        }
    }
        ...
        if (isFdroid) {
            ...
            variant.outputs
                ...
                .forEach { output ->
                    ...
                    output.outputFileName = "ZeroVPN_${variant.versionName}-fdroid_${abi}.apk"
            ...
            variant.outputs
                ...
                .forEach { output ->
                    ...
                    output.outputFileName = "ZeroVPN_${variant.versionName}_${abi}.apk"
                    if (versionCodes.containsKey(abi)) {
                        output.versionCodeOverride =
